...
pickle.dump (words, open ('words.pkl', 'wb'))   #save the 'words' object to a file named 'words.pkl' in binary mode.
#  pickle.dump() function serializes the 'words' object, converting it into a byte stream and writes it to the specified file
